...
export default class extends AbstractView {
    ...
    async getHtml() {
        let page =
			`
				<div id="singUpDiv" class="container py-5 h-100">
								...
								<div class="card-body p-5 text-center" >
									<div>
										...
										<div class="form-outline form-white mb-4">
											<input type="text" id="Name" placeholder="Name" class="inputSingUp form-control form-control-lg"/>
										</div>
										<div class="form-outline form-white mb-4">
											<input type="text" id="UserName" placeholder="Username" class="inputSingUp form-control form-control-lg"/>
										</div>
										<div class="form-outline form-white mb-4">
											<input type="password" id="PassWord" placeholder="Password" class="inputSingUp form-control form-control-lg password"/>
										</div>
										<div class="form-outline form-white mb-4">
											<input type="password" id="PassWordRep" placeholder="Repeat password" class="inputSingUp form-control form-control-lg password"/>
										</div>
										<div id="errorDiv">
